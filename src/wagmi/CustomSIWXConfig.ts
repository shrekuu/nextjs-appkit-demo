...
import type { SIWXConfig as SIWXConfigInterface, SIWXMessage, SIWXSession } from "@reown/appkit";
import type { SIWXMessenger, SIWXStorage, SIWXVerifier } from "@reown/appkit-siwx";
